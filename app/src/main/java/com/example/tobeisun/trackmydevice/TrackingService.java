package com.example.tobeisun.trackmydevice;


//this service is responsible for sending the device's location to firebase
...
//Make this notification ongoing so it can’t be dismissed by the user//
                .setOngoing(true).setContentIntent(broadcastIntent).setSmallIcon(R.drawable.tracking_enabled);
